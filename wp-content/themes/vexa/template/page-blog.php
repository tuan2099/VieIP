    ...
    <?php
        ...
        <section class="relative overflow-hidden">
            <div class="md:px-0 py-20 md:py-28">
                ...
                <!-- Card overlay -->
                <article class="absolute left-0 bottom-0 translate-y-1/3 md:translate-y-1/3 lg:-translate-y-24 w-full max-w-lg max-h-lg">
                    ...
                    <div class="mt-6 space-y-1 font-['Philosopher']">
                        ...
                        <p class="text-sm font-bold tracking-wide text-[black] font-['Lexend']">BY <?php echo esc_html($author); ?></p>
                    </div>
                    </div>
                </article>
                ...
                while ( $q->have_posts() ) : $q->the_post();
                    ...
                    <article class="bg-[#1a1a22] mb-[30px] rounded-3xl shadow-xl ring-1 ring-white/5 overflow-hidden">
                        ...
                        <div class="flex flex-col col-span-3 justify-center p-6 md:p-10">
                            ...
                            Posted On: <span class="font-medium text-[#FFFFFFB0] font-['Lexend']"><?php echo esc_html( get_the_date('M d, Y') ); ?></span>
                            </p>
                        </div>
                        </div>
                    </article>
        ...
        <aside class="lg:col-span-1">
            ...
            <section class="max-w-6xl mx-auto py-12">
                <div class="">
                    ...
                    if ($q->have_posts()) :
                    while ($q->have_posts()) : $q->the_post(); ?>
                        <article class="bg-[#1a1a22] my-[25px] rounded-3xl overflow-hidden shadow-lg/30 shadow-black/20 hover:shadow-black/30 transition-shadow">
