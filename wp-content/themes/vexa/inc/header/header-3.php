...
<?php 
    ...
    <a href="#" id="vexa-go-top" class="fixed bottom-6 right-6 z-50 p-3 rounded-full text-black shadow-lg hover:bg-indigo-700"><i class="fa-solid fa-arrow-up"></i></a>
<?php endif; ?>
<!-- // Back to top button -->
...
<header class="border-b border-gray-800"
    ...
    >
        ...
        <a
                ...
                data-aos="fade-right" data-aos-delay="100" data-aos-duration="650" data-aos-once="true"
        >
