                        ...
                        if ( $q->have_posts() ) : ?>
                            ...
                            <article class="relative overflow-hidden rounded-2xl group">
                                ...
                                <?php if ($facebook || $linkedin || $twitter): ?>
                                    ...
                                    <?php if ($facebook): ?>
                                        <a href="<?php echo esc_url($facebook); ?>" aria-label="Facebook" class="hover:text-gray-200" target="_blank" rel="noopener">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 5 3.66 9.13 8.44 9.88v-6.99H8.9v-2.89h1.54V9.8c0-1.52.9-2.36 2.28-2.36.66 0 1.35.12 1.35.12v1.49h-.76c-.75 0-.98.47-.98.96v1.15h1.67l-.27 2.89h-1.4v6.99C18.34 21.13 22 17 22 12z"/></svg>
                                        </a>
                                    <?php endif; ?>
                                    <?php if ($linkedin): ?>
                                        <a href="<?php echo esc_url($linkedin); ?>" aria-label="LinkedIn" class="hover:text-gray-200" target="_blank" rel="noopener">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M4.98 3.5C4.98 4.88 3.86 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.5 8h4V23h-4V8zm7 0h3.84v2.05h.05c.54-1.02 1.86-2.1 3.83-2.1 4.1 0 4.86 2.7 4.86 6.2V23h-4v-6.6c0-1.58-.03-3.62-2.2-3.62-2.2 0-2.53 1.72-2.53 3.5V23h-4V8z"/></svg>
                                        </a>
                                    <?php endif; ?>
                                    <?php if ($twitter): ?>
                                        <a href="<?php echo esc_url($twitter); ?>" aria-label="Twitter/X" class="hover:text-gray-200" target="_blank" rel="noopener">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M21.53 2.5 13.9 11.1l7.86 10.4h-3.4L12.9 13.9 7.2 21.5H2.5l8.2-9.9L3.3 2.5h3.4l5 6.7 6.2-6.7h3.63z"/></svg>
                                        </a>
                                    <?php endif; ?>
                                    </div>
                                <?php endif; ?>
