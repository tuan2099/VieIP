...
?>
        ...
        <div class="relative">
            ...
            <div class="rounded-2xl bg-[#15161c] p-8 shadow-2xl ring-1 ring-white/10 sm:p-12">
                <form class="space-y-6">
                    ...
                    <button class="font-['Lexend'] w-full lg:w-auto lg:w-none text-center inline-block bg-[#552ae0] rounded-full border-2 border-[#552ae0] px-12 py-3 text-[16px] font-medium text-purple-200 hover:bg-[#552ae0] hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-[#552ae0]"
    ...
    <div class="grid items-start gap-12 lg:grid-cols-[1.1fr_.9fr] mb-32 lg:mb-64 max-w-[1440px] p-5 lg:p-0 mx-auto">
        ...
        <div class="relative rounded-2xl overflow-hidden ring-1 ring-white/10 shadow-2xl">
          ...
          <svg class="relative h-9 w-9 text-rose-500 drop-shadow" viewBox="0 0 24 24" fill="currentColor"
               aria-hidden="true">
        ...
        <section class="pt-2">
            ...
            <ul class="space-y-8">
                ...
                <li class="flex items-center gap-4">
                    ...
                    <div class="space-x-2">
                        <a href="mailto:info@plox.com"
                           class="text-white/90 hover:text-white underline decoration-white/20 hover:decoration-white"><?php echo esc_html($vexatheme_option['email']); ?></a>
                        <span class="text-white/40">|</span>
                        <a href="mailto:support@plox.com"
                           class="text-white/90 hover:text-white underline decoration-white/20 hover:decoration-white">support@plox.com</a>
                    </div>
                </li>
                ...
                <li class="flex items-center gap-4">
                    ...
                    <a href="tel:+16464442106"
                       class="text-white/90 hover:text-white"><?php echo esc_html($vexatheme_option['telphone']); ?></a>
                </li>
            </ul>
        </section>
    </div>
