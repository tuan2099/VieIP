    ...
    <div class="py-16 md:py-24 max-w-[1440px] mx-auto lg:mb-64 mb-32 px-5 lg:px-0"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16">
            ...
            <div class="order-2 flex flex-col justify-center space-y-6 lg:space-y-8"
                 data-aos="fade-left" data-aos-delay="100" data-aos-duration="700" data-aos-once="true">
                ...
                <div>
                    <div class="inline-flex items-center gap-3 mb-4"
                        ...
                        <div class="w-12 h-12 rounded-full bg-gradient-to-r from-orange-500 to-pink-500 flex items-center justify-center"
                             data-aos="zoom-in" data-aos-delay="150" data-aos-duration="550" data-aos-once="true">
                            <span class="text-white text-xl font-bold">F</span>
                        </div>
                        <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-white"
                            data-aos="fade-up" data-aos-delay="180" data-aos-duration="650" data-aos-once="true">
                            Fashion Photoshoot
                        </h1>
                    </div>
                </div>
                ...
                <!-- Description -->
                <div class="space-y-4"
                     data-aos="fade-up" data-aos-delay="220" data-aos-duration="700" data-aos-once="true">
                ...
                <div class="flex items-center gap-6 py-4 border-t border-b border-gray-700/50"
                     data-aos="fade-up" data-aos-delay="260" data-aos-duration="650" data-aos-once="true">
                    <button class="flex items-center gap-2 text-gray-400 hover:text-pink-500 transition-colors duration-300"
                            data-aos="zoom-in" data-aos-delay="280" data-aos-duration="550" data-aos-once="true">
                    ...
                    <button class="flex items-center gap-2 text-gray-400 hover:text-blue-500 transition-colors duration-300"
                            data-aos="zoom-in" data-aos-delay="320" data-aos-duration="550" data-aos-once="true">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8 pt-4"
                     data-aos="fade-up" data-aos-delay="340" data-aos-duration="700" data-aos-once="true">
                    <!-- Categories -->
                    <div data-aos="fade-up" data-aos-delay="0" data-aos-duration="650" data-aos-once="true">
                    ...
                    <!-- Client -->
                    <div data-aos="fade-up" data-aos-delay="80" data-aos-duration="650" data-aos-once="true">
                        <h3 class="text-white font-bold text-lg mb-3">Client</h3>
                        <p class="text-gray-400">Dolce &amp; Gabbana</p>
                    </div>

                    <!-- Release Date -->
                    <div data-aos="fade-up" data-aos-delay="160" data-aos-duration="650" data-aos-once="true">
                        <h3 class="text-white font-bold text-lg mb-3">Release Date</h3>
                        <p class="text-gray-400">March 14, 2021</p>
                    </div>

                    <!-- Tags -->
                    <div data-aos="fade-up" data-aos-delay="240" data-aos-duration="650" data-aos-once="true">
