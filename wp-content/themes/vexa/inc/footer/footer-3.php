...
<section aria-labelledby="hero-title" class="relative max-w-[1400px] -mt-[8%] mx-auto pb-28"
    ...
    <div class="relative rounded-[35px] overflow-hidden z-10 max-w-[1250px] w-full mx-auto"
         data-aos="zoom-in-up" data-aos-delay="150" data-aos-duration="700" data-aos-once="true">
        ...
        <div class="relative px-6 sm:px-10 lg:px-14 pt-16 sm:pt-24 pb-8 sm:pb-10 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-0 items-center">
            <h2 id="hero-title"
                class="max-w-96 text-white text-3xl sm:text-4xl font-bold leading-[1.2] sm:leading-[52px]"
            ...
            <form class="mt-6 lg:mt-8 relative" action="#" method="post" aria-label="Email sign-up"
                  data-aos="fade-left" data-aos-delay="250" data-aos-duration="650" data-aos-once="true">
                ...
                <button
                        ...
                        data-aos="zoom-in" data-aos-delay="350" data-aos-duration="550" data-aos-once="true"
                >
                    Send
                </button>
            </form>
...
<footer class="max-w-[1440px] mx-auto pb-9 px-6 sm:px-9" role="contentinfo" aria-labelledby="footer-title"
    ...
    <div class="max-w-[1400px] mx-auto pb-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6"
        ...
        <section class="space-y-6 lg:col-span-2" aria-labelledby="footer-cta-title"
            ...
            >
                <img class="w-[150px]" src="<?php if (is_page() && !empty($vexatheme_meta['custom_header'])) {
            ...
            <h3 id="footer-cta-title"
                class="text-[#7c91b3] text-2xl sm:text-3xl font-bold font-['Philosopher'] leading-9 sm:leading-10"
            ...
            <div class="flex items-center gap-4 flex-wrap"
                ...
                <a href="#contact"
                   class="inline-flex items-center h-12 px-12 rounded-[35px] bg-gradient-to-b from-[#451fc2] to-[#5d30ee] text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                   title="Get in touch"
                   data-aos="zoom-in" data-aos-delay="180" data-aos-duration="550" data-aos-once="true">
                    GET IN TOUCH <span class="ml-2 text-base" aria-hidden="true">&rsaquo;</span>
                </a>

                <span class="h-8 w-2 bg-blue-300" aria-hidden="true"
                      data-aos="fade" data-aos-delay="190" data-aos-duration="600" data-aos-once="true"></span>

                <div class="flex items-center gap-3"
                     data-aos="fade-left" data-aos-delay="220" data-aos-duration="600" data-aos-once="true">
                    <i class="fa-solid fa-phone w-6 h-6 text-rose-500"></i>
                    <div class="leading-tight">
                        <div class="text-[#7C91B3C2] text-xs">CALL US NOW!</div>
                        <a href="tel:5666787813" class="text-[#7c91b3] text-base font-bold"
                           title="Call 566-678-7813"><?php echo esc_html($vexatheme_option['telphone']); ?></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <nav aria-labelledby="footer-company-title" class="space-y-4"
            ...
            <h4 id="footer-company-title" class="text-[#7c91b3] text-lg font-bold font-['Philosopher']"
                data-aos="fade-up" data-aos-delay="80" data-aos-duration="600" data-aos-once="true">Company</h4>
        ...
        <nav aria-labelledby="footer-services-title" class="space-y-4"
             data-aos="fade-up" data-aos-duration="700" data-aos-once="true">
            <h4 id="footer-services-title" class="text-[#7c91b3] text-lg font-bold font-['Philosopher']"
                data-aos="fade-up" data-aos-delay="80" data-aos-duration="600" data-aos-once="true">Services</h4>
                ...
                if ($q->have_posts()) :
                    while ($q->have_posts()) : $q->the_post(); ?>
                        <li class="relative pl-3"
                            ...
                            <span class="absolute -left-3 top-2 w-[5px] h-[5px] bg-rose-500 rounded-full"
                    ...
                    <li class="relative pl-3" data-aos="fade-up" data-aos-duration="600" data-aos-once="true">
                        <span class="absolute -left-3 top-2 w-[5px] h-[5px] bg-rose-500 rounded-full"
                              aria-hidden="true"></span>
        ...
        <section aria-labelledby="footer-latest-title" class="space-y-4"
            ...
            <h4 id="footer-latest-title" class="text-[#7c91b3] text-lg font-bold font-['Philosopher']"
                data-aos="fade-up" data-aos-delay="80" data-aos-duration="600" data-aos-once="true">
                Latest Articles
            </h4>
            ...
            if ($latest->have_posts()) :
                while ($latest->have_posts()) : $latest->the_post();
                    ...
                    <article class="relative pl-3"
                        ...
                        <div class="mt-2 text-xs text-slate-500/70" data-aos="fade" data-aos-delay="100" data-aos-duration="500" data-aos-once="true">
                ...
                ?>
                <article class="relative pl-3" data-aos="fade-up" data-aos-duration="600" data-aos-once="true">
                    <span class="absolute -left-3 top-2 w-[5px] h-[5px] bg-rose-500 rounded-full"
                          aria-hidden="true"></span>
